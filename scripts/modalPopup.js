...
var bioInfo = {
  ...
  'selena-bio' : "Selena is a sophomore studying Industrial Design and Computation and Technology at RISD. She is interested in human centered design and designing for space. In her free time she walks with her highly energetic dog, learns to sew, and watches Barbie movies with her roommate.",
  'alexis-bio' : "Alexis is a Junior at RISD. She is from Maryland about 20 mins from D.C. She loves painting and cuddling with her cat. Win her heart with pickles.",
  'truman-bio' : "Truman is a junior studying graphic design at the Rhode Island School of Design. Through his studies, he hopes to develop a unique approach to visual communication through practical experience, research, and critique. Some of his favorite activities include learning plant names, reading music reviews, and cuffing his pant legs.",
  'bright-bio' : "Bright Tsagli is a current sophomore studying Business Economics and Public Policy and a member of the Resumed Undergraduate Experience (RUE) program. As a global citizen, he calls Ghana and Germany home. Last year, Bright served on Better World’s Community Public Relations team, and he is excited to return this year to serve in the same role. He is curious about how the world and his current subject interest include Math, public policy, economics, and data science to understand better how the world’s resources, from both the public and private sectors, could be allocated more efficiently to prevent poverty-related issues.",
  'christine-bio' : "Christine is a freshman at Brown studying Applied Mathematics. Made in Ohio, Christine was raised in South Korea and came to Georgia to suffer in 90 degrees summers. Her biggest accomplishment over quarantine was reading Harry Potter series for the first time and finishing Grey's Anatomy in a month. ",
  'nicole-bio' : "Nicole is a junior at Brown studying Computer Science. She is interested in designing for accessibility. Also a comedy lover, Nicole enjoys watching SNL, writing jokes, and scrolling through Twitter.",
  'angela-bio' : "Angela is a junior at Brown studying Computer Science with a particular interest in UI/UX and accessibility in design. She grew up in the warm and lively city of Accra in Ghana and enjoys building lavish mansions for her Sims. She also loves baking, watching series and anime in her free time  as well as playing her carefully collated Westlife playlist on repeat, which attributes to 70% of her sleep deprivation (because every song deserves at least 3 replays).",
  'delora-bio' : "Delora is a sophomore at Brown studying Computer Science and Human-Centered Design. She is from Seattle, Washington, and is very interested in storytelling and accessibility within design, especially the industry of UIUX. Delora enjoys taking walks, and baking or cooking food (especially oatmeal)!",
