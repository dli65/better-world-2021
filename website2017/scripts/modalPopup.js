...
var bioInfo = {
	...
	'brian-name'		:	'Brian Oppenheim',
	'carmen-name'		: 'Carmen Zheng',
	'curtis-name'		:	'Curtis Stiles',
	'dylan-name'		:	'Dylan Morrissey',
	'elaine-name'		:	'Elaine Lu',
	'javier-name'		: 'Javier Syquia',
	'joseph-name'		:	'Joseph Chen',
	'kana-name'			:	'Kana Hamamoto',
	'katherine-name': 'Katherine Chavez',
	'kathleen-name' : 'Kathleen Chai',
	'kendra-name'   : 'Kendra Xu',
	'michelle-name' : 'Michelle Devlin',
	'natasha-name'  : 'Natasha Orlando Figueiredo',
	...
	'maya-img'     : 'url(images/team2017/Maya.jpg)',
	'noah-img'     : 'url(images/team2017/Noah.jpg)',
	'phoebe-img'   : 'url(images/team/Phoebe.jpg)',
	'raina-img'    : 'url(images/team2017/Raina.jpg)',
	'taryn-img'    : 'url(images/team/Taryn.jpg)',
	'teri-img'     : 'url(images/team2017/Teri.jpg)',
	'zoe-img'      : 'url(images/team/Zoe.jpg)',

	'brian-img'    : 'url(images/team2017/Brian.jpg)',
	'carmen-img'	 : 'url(images/team2017/Carmen.jpg)',
	'curtis-img'	 : 'url(images/team2017/Curtis.jpg)',
	'dylan-img'	 : 'url(images/team2017/Dylan.jpg)',
	'elaine-img'	 : 'url(images/team2017/Elaine.jpg)',
	'javier-img'	 : 'url(images/team2017/Javier.jpg)',
	'joseph-img'	 : 'url(images/team2017/Joseph.jpg)',
	'kana-img'	 : 'url(images/team2017/Kana.jpg)',
	'katherine-img'	 : 'url(images/team2017/Katherine.jpg)',
	'kathleen-img'	 : 'url(images/team2017/Kathleen.jpg)',
	'kendra-img'	 : 'url(images/team2017/Kendra.jpg)',
	'michelle-img'	 : 'url(images/team2017/Michelle.jpg)',
	'natasha-img'	 : 'url(images/team2017/Natasha.jpg)',
	'nick-img'	 : 'url(images/team2017/Nick.jpg)',
	'tina-img'	 : 'url(images/team2017/Tina.jpg)',
	'wen-img'		 : 'url(images/team2017/Wen.jpg)',
	...
	'maya-bio'     : "Hailing from sunny Los Angeles, CA, Maya is passionate about social innovation and human behavior and is studying cognitive neuroscience at Brown. She is excited to be part of Better World because she gets really fired up by great ideas! Find her at a group fitness class, a local craft fair, or eating  avocado toast.",
	'noah-bio'     : "Born and raised in Chicago, Noah is an undergraduate student at Brown studying Latin American History and Economics. He is interested in how design can be applied to government. His favorite sandwich is a B.L.A.T.",
	...
	'teri-bio'     : "Born and raised in New Jersey, Teri now studies art history and economics at Brown. She is passionate about the intersection of design and entrepreneurship, and is always looking for new ways to connect to the creative community in Providence. In her free time, Teri regularly attends gallery openings, curates exhibitions and illustrates for local publications.",
	...
	'brian-bio'		 : "A proud Seattleite and product of the Pacific Northbest, Brian is passionate about the preservation of our environment and its natural resources. Through his fascination with technology, he hopes to study Computer Science in order to create solutions to problems in areas like medicine or the proliferation of green energy. You can find Brian hiking, spending time with friends, or searching for the perfect sprite-nog (sprite+eggnog) recipe.",
	'carmen-bio'	 : "Hailing from The Middle of Nowhere, Maryland, Carmen is a sophomore at Brown studying Public Health. She is interested in exploring the intersection of healthcare, technology, and digital design. In her free time, Carmen enjoys painting, video blogging, and going on foodie adventures.",
	'curtis-bio'	 : "Curtis is a multi-celled organism of the kingdom <i>brunonia</i>, phylum <i>sophomorus</i> and class <i>nineteenia</i>. A Curtis is distinct in its love of design and entrepreneurship. This rare creature is nocturnal, tending to forage late at night for ambient lighting and wild sticks of mozzarella. When not hunting the <i>internshipus elusivus</i>, Curtis can be found migrating across great distances and ripping off David Attenborough.",
	'dylan-bio'		 : "Dylan is a junior from Los Angeles concentrating in architecture at Brown. He is interested in the intersection between politics and architecture and enjoys studying both architectural history at Brown and design at RISD. While cutting and gluing small pieces of paper, Dylan daydreams about rollerskating at his favorite rink from the '80s, planning trips to admire his favorite buildings, and devouring ice cream on the beach.",
	'elaine-bio'	 : "Elaine is a Bay Area native studying Industrial Design at RISD. She is interested in products, technology, services, and how they affect human experience. When not designing, reading magazines or drinking tea, she is likely to be found hanging out at bougie coffee shops while planning her next day out.",
	'javier-bio'	 : "Coming from the Philippines, Javier is a first year student planning to major in Graphic Design at RISD, and Chemistry at Brown. He is immensly intersted in the relationships between art, design, and STEM, and hopes to find more connections between them through his studies. Outside of class, Javier can be found watching Netflix, instagraming his food, decorating his room, and most of all being facinsated by snow.",
	'joseph-bio'	 : "Born in Singapore but raised under the scintilating California sun, Joseph now finds himself navigating through the beautiful (but frigid) city of Providence as a first-year student at Brown studying Neuroscience. Joseph is especially fascinated with the implementation of effective design in medical technology and development programs to combat global health and social problems. When he has the luxury of diverging from his studies, Joseph can most likely be found in the pool swimming the time away, in the kitchen cooking his worries away, or in the audience of a stand-up comedy show laughing life's stressful moments away. ",
	'kana-bio'		 : "From Tokyo, Japan, Kana is a junior studying Psychology at Brown, interested in how childhoo development affect personality and human behavior. She is fascinated by the power of technology and design as a communication tool. Outside academics, she can be found searching for cookie recipes, baking cookies or munching on cookies.",
	'katherine-bio': "Katherine Chavez is a baby-carrot-eater, sophomore, and proud Chicana. She intends to study Art History, focusing on Latin American art and representation/social hiearchies in museums and arts education, and Visual Art. A native of Los Angeles, California, she finds inspiration in music and art that intersects with activism, pugs, and R&B.",
	'kathleen-bio' : "Kathleen is a freshman at Brown from New Jersey studying applied math and economics with visual arts on the side. When not drowning in homework, Kat can be spotted in a coffee shop or art museum.",
	'kendra-bio'	 : "Born in Shanghai, China, Kendra is an international student who grew up in sunny island Singapore. Her work focuses on psychological states, language and translation, as well as mankind's relationship with technology, and she hopes to play a part in shaping the future of social exchange and information navigation in an increasingly connected yet divisive world. Outside of class, she indulges in painting, reading, binge-watching John Oliver, and playing musical instruments badly.",
	'michelle-bio' : "From Guam and now living between New York and Rhode Island, Michelle studies Graphic Design at RISD. She is interested in the intersection of design, social issues, and personal history. She also co-leads an annual food + art zine at RISD called the Cook Book.",
	'natasha-bio'  : "Natasha is a sophomore at Brown studying art history. She has a passion for innovative social media connections and hopes to increase public access and interest in art and design. A true New Yorker, Natasha's favorite pastimes include eating everything bagels and enjoying public art.",
	'nick-bio'		 : "Raised in Nashville, Nicholas is currently a sophomore at Brown studying math and linguistics. He's currently working on a translation of the Communist Manifesto into emoji and can be found drinking copious amounts of bubble tea.",
	'tina-bio'		 : "After renouncing her past life as an undercover ghost meseuse in the suburbs of Atlanta, Tina settled down to study neuroscience and visual art at Brown University. Her talents sometimes include flipping the book to the right page without looking and running out of shampoo and conditioner at the same time. She is interested in STEAM, neuroaesthetics, and medical illustration. Talk to her about her extensive collection of beautiful but untouched notebooks.",
	'wen-bio'			 : "Wen is enamored with the ins and outs of narratives, both personal and impersonal, that are found in the everyday. She is excited by cross-overs between fine art and design and believes Better World is the perfect platform to showcase the possiblities of that relationship. A third year photo student at RISD, she's an avid podcast listener, firm believer of To-Do lists and genuinely enjoys long walks, but maybe not by the beach.",
